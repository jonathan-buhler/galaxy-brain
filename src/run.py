...
from ganaxy import Generator_Stage1, Generator_Stage2
...
parser.add_argument('--dcgan_G', 
                    type = str, 
                    default = './src/saved_models/dcgan_G.pth', 
                    help = 'filename of the 32->64 generator model')
parser.add_argument('--stackgan_G', 
                    type = str, 
                    default = './src/saved_models/stackgan_G.pth', 
...
def run_pipeline():
    ...
    # save the images --------------------------------
    vutils.save_image(fake_64.data,
            './src/samples/ganaxy/fake_sample_{}.png'.format(r_seed),
            normalize=True)
